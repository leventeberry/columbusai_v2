...
Root `docker-compose.yml` includes [compose.prod.yml](../../infra/docker/compose.prod.yml). Production uses self-hosted n8n with metadata in the `n8n` database. See [deployment.md](deployment.md).
