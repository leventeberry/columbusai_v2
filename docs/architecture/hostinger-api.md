...
TypeScript scripts under [`scripts/hostinger/`](../../scripts/hostinger/) use the official [`hostinger-api-sdk`](https://github.com/hostinger/api-typescript-sdk) and repo-root `.env.production` (see [environment.md](environment.md)).
...
- [deployment.md](deployment.md) — routing, verification, backups
