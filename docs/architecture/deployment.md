...
3. Copy [.env.production.example](../../.env.production.example) to `.env.production` and set values (see [environment.md](environment.md)). **Never commit live env files.**
...
See also [postgres.md](postgres.md) and [demo-request-workflow.md](../workflows/demo-request-workflow.md).
