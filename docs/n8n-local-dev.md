...
See [env.md](env.md). `pnpm n8n:*` loads `.env.local` unless `COLUMBUS_ENV=production`.
...
See also [n8n-workflow-sync.md](n8n-workflow-sync.md), [demo-request-workflow.md](demo-request-workflow.md), [demo-follow-up-workflow.md](demo-follow-up-workflow.md).
