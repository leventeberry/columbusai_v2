...
export const leads: Lead[] = [
  ...
  {
    id: "l11",
    company: "Crater Foods",
    contact: "Eli Bergman",
    service: "Inventory Bot",
    score: 52,
    value: 16000,
    stage: "lost",
  },
...
export const agents: Agent[] = [
  {
    ...
    role: "Qualifies inbound leads & books meetings",
    enabled: true,
    requests: 3120,
    avgResponseMs: 720,
    costToday: 18.42,
  ...
  },
  {
    ...
    role: "Tier-1 ticket resolution across channels",
    enabled: true,
    requests: 4821,
    avgResponseMs: 540,
    costToday: 24.1,
  ...
  },
  {
    id: "a3",
    name: "Content Agent",
    role: "Drafts blog posts, emails & social copy",
    enabled: true,
    requests: 612,
    avgResponseMs: 1820,
    costToday: 9.75,
  ...
  },
  {
    id: "a4",
    name: "Data Analyst",
    role: "Answers ad-hoc data questions over the warehouse",
    enabled: false,
    requests: 84,
    avgResponseMs: 2400,
    costToday: 2.18,
  ...
  },
  {
    ...
    role: "Automates payroll, ops & scheduling tasks",
    enabled: true,
    requests: 412,
    avgResponseMs: 980,
    costToday: 5.62,
...
export const conversations: Conversation[] = [
  ...
  },
  {
    id: "cv2",
    user: "ops@beacon.co",
    agent: "Internal Operations Agent",
    lastMessage: "Can you re-run the payroll batch?",
    sentiment: "neutral",
    status: "open",
    timestamp: "6m ago",
  },
  {
    id: "cv3",
    user: "finance@cobalt.io",
    agent: "Data Analyst",
    lastMessage: "This isn't reconciling with NetSuite.",
    sentiment: "negative",
    status: "escalated",
    timestamp: "14m ago",
  },
  {
    id: "cv4",
    user: "lead@northwind.com",
    agent: "Sales Assistant",
    lastMessage: "Booked Thursday at 2pm.",
    sentiment: "positive",
    status: "resolved",
    timestamp: "22m ago",
  },
  {
    id: "cv5",
    user: "press@verge.studio",
    agent: "Content Agent",
    lastMessage: "Tighten the second paragraph.",
    sentiment: "neutral",
    status: "open",
    timestamp: "38m ago",
  },
...
export const audit: AuditEvent[] = [
  {
    ...
    target: "Inbound Lead Enrichment",
    at: "2m ago",
  },
  {
    id: "e2",
