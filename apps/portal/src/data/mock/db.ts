...
const seedUsers: User[] = [
  ...
  },
  {
    id: "u-riley",
    name: "Riley Banks",
    email: "riley@bluelinefitness.com",
    initials: "RB",
    kind: "client",
    clientId: "c-blueline",
  },
  ...
  return [
    {
      ...
      description:
        "Dedicated page for Dermaplaning with pricing, before/after photos, and a booking CTA.",
      type: "website",
      status: "in_progress",
      priority: "medium",
      clientId: "c-kdm",
      createdBy: "u-kira",
      primaryAssigneeId: "u-devon",
      assigneeIds: ["u-devon"],
      watcherIds: ["u-maya", "u-alex"],
      tags: ["service-page"],
      createdAt: iso(6),
      updatedAt: iso(0, 5),
    },
    {
      ...
      clientId: "c-kdm",
      createdBy: "u-kira",
      primaryAssigneeId: "u-maya",
      assigneeIds: ["u-maya"],
      watcherIds: ["u-levente"],
      tags: ["reminders"],
      createdAt: iso(8),
      updatedAt: iso(1),
    },
    {
      ...
      description:
        "Booking confirmations should opt clients into our monthly newsletter (Mailchimp).",
      type: "integration",
      status: "in_review",
      priority: "medium",
      clientId: "c-kdm",
    ...
    },
    {
      ...
      description: "Refresh listed prices for facials and chemical peels.",
      type: "website",
      status: "completed",
      priority: "low",
      clientId: "c-kdm",
    ...
    },
    {
      ...
      description:
        "Reported by a client — the booking form's submit button does nothing on Safari iOS 17.",
      type: "bug",
      status: "in_progress",
      priority: "critical",
      clientId: "c-kdm",
      createdBy: "u-kira",
      primaryAssigneeId: "u-levente",
      assigneeIds: ["u-levente", "u-devon"],
      watcherIds: ["u-maya"],
      tags: ["safari", "booking"],
      createdAt: iso(1),
      updatedAt: iso(0, 2),
    },
    {
      ...
      description: "Pull Q1 numbers, draft recommendations, schedule call.",
      type: "internal",
      status: "in_progress",
      priority: "medium",
      clientId: "c-kdm",
      createdBy: "u-levente",
      primaryAssigneeId: "u-sasha",
      assigneeIds: ["u-sasha"],
      watcherIds: ["u-levente"],
      tags: ["qbr"],
      createdAt: iso(4),
    ...
    {
      id: "WI-1035",
      title: "Onboarding — Arroyo Dental Studio",
      description: "Kickoff, brand assets, hosting transfer, automation discovery.",
      type: "onboarding",
      status: "in_progress",
      priority: "high",
      clientId: "c-arroyo",
    ...
    {
      id: "WI-1034",
      title: "Deploy new homepage hero",
      description: "Push approved hero design to production after QA.",
      type: "deployment",
      status: "testing",
      priority: "medium",
      clientId: "c-blueline",
    ...
    {
      id: "WI-1033",
      title: "Stripe webhook returning 401 intermittently",
      description:
        "We're seeing periodic 401s from the Stripe webhook endpoint. Investigate retries.",
      type: "support",
...
function seedComments(): WorkComment[] {
  return [
    ...
    },
    {
      ...
      workItemId: "WI-1042",
      authorId: "u-devon",
      body: "SEO review pending from @Maya before we publish.",
      visibility: "internal",
      mentions: ["u-maya"],
      createdAt: iso(0, 5),
    },
    ...
    },
    {
      ...
      workItemId: "WI-1037",
      authorId: "u-levente",
      body: "Reproduced on Safari 17.4. Looks like a missing event preventDefault on submit.",
      visibility: "internal",
      mentions: [],
      createdAt: iso(0, 4),
    },
    {
      ...
      workItemId: "WI-1037",
      authorId: "u-devon",
      body: "Patch deployed to staging — please retest @Kira.",
      visibility: "public",
      mentions: ["u-kira"],
      createdAt: iso(0, 2),
    },
  ...
  for (const w of items) {
    ...
    if (w.status !== "requested") {
      activity.push({
        id: sid("ac"),
        workItemId: w.id,
        actorId: w.primaryAssigneeId ?? "u-levente",
        kind: "status_changed",
        from: "requested",
        to: w.status,
