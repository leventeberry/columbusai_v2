...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Terms of service for the Columbus AI platform and managed services." },
    ...
    <SiteLayout>
      <section className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-24">
        ...
        <p className="mt-4 text-muted-foreground">
          Placeholder terms of service. Full terms will be published before any new
          commercial agreement. For details in the meantime, email{" "}
