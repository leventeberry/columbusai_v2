...
export const Route = createFileRoute("/workflows")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Examples of automations Columbus AI runs: lead routing, missed-call text-back, reminders, reviews, onboarding, and more." },
      { property: "og:title", content: "Workflows — Columbus AI" },
      { property: "og:description", content: "A trigger fires, the system acts, and the outcome compounds." },
