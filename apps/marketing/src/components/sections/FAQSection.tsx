...
const faqs = [
  { q: "What does Columbus AI actually build?", a: "Hosted websites, workflow automations, client portals, integrations, AI assistants, and reporting — managed as one system." },
  { q: "Do you replace my current tools?", a: "No. We connect what you already use (CRM, calendar, email, payments) and add automation on top." },
  { q: "Can you work with my existing website?", a: "Yes. We can host and improve it, or rebuild it if a new site would serve you better." },
  { q: "Do clients get their own portal?", a: "Yes. Every client gets a portal with visibility into results, requests, reports, billing, and documents." },
