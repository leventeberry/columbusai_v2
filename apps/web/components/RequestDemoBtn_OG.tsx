        ...
        >
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className={cn(
                "flex h-9 w-full rounded-md border bg-transparent px-3 py-2 text-sm shadow-xs outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50",
                fieldState("team_size").inputClass
              )}
              {...register("team_size")}
            >
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className={cn(
                "flex h-9 w-full rounded-md border bg-transparent px-3 py-2 text-sm shadow-xs outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50",
                fieldState("timeline").inputClass
              )}
              {...register("timeline")}
            >
